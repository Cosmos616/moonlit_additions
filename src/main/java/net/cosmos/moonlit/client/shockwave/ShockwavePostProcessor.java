package net.cosmos.moonlit.client.shockwave;
...
public class ShockwavePostProcessor {
    ...
    public static void load() {
        ...
        try {
            ...
            Moonlit.LOGGER.error("Failed to load shockwave post shader", exception);
    ...
    private static void resizeIfNeeded() {
        ...
        if (width != lastWidth || height != lastHeight) {
            ...
            Moonlit.LOGGER.info("Resized shockwave post shader to {}x{}", width, height);
        }
    }
